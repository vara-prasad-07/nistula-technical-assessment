...
class ClaudeService:
    ...
    async def generate_reply(self, normalized_message: dict) -> dict:
        ...
        **IMPORTANT: You ONLY answer questions related to hospitality, villa amenities, bookings, and guest services.**
        
        For any query that is NOT related to hospitality (such as general knowledge, tech support, politics, etc.):
        Respond with: "Sorry, this query is irrelevant. I can only assist with hospitality-related questions about your villa stay, bookings, amenities, or check-in/check-out details."
